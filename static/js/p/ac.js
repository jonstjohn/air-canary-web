var app = angular.module('acApp', ['ngRoute']).config( function($routeProvider, $locationProvider, $interpolateProvider, $httpProvider) {
    ...
    $routeProvider.when('/p/:latitude/:longitude', {
        templateUrl: '/ng/point',
        controller: PntCntl
    });
...
function PntCntl($rootScope, $scope, $route, $routeParams, $http, $location, siteService, dataService, $timeout) {
    ...
    var loadData = function() {
        ...
        var httpRequest = $http({
            method: 'GET',
            url: '/point/' + $routeParams.latitude + ',' + $routeParams.longitude
        }).success(function(data, status) {
            console.log(data);
